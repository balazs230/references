                                            ...
                                            @method('PUT')
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-sm-6 col-xl-9">
                                                        <div class="form-group">
                                                            ...
                                                            @if (count($categories) > 0)
                                                               ...
                                                               <option value="{{ $category->id }}" {{ $category->id == $article->category->id ? 'selected' : null }}>{{ $category->category_name }}</option>
                                                    ...
                                                    <div class="col-sm-6 col-xl-3">
                                                        <button class="btn btn-primary shadow-1 text-uppercase btn-block" style="margin-top: 28px;" type="submit">update article</button>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="tinymce-editor">{{ $article->content }}</textarea>
                                                @error('content')
                                                <small class="form-text" style="color: red;">{{ $message }}</small>
                                                    @enderror
                                            </form>
