...
<!-- Afiseaza pe blog articolele doar unei categorii -->
  ...
  <div class="container">
    ...
    @if (count($articles) > 0)
        @foreach ($articles as $article)
            <div class="card mb-4">
          <img class="card-img-top" src="{{ asset('blog/images/blog.jpg') }}" alt="Card image cap" />
          <div class="card-body">
    ...
    @else
          ...
          <h5>There are no articles in this category.</h5>
