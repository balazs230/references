...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
              <!--  <h4 class="border border-top-0 border-left-0 border-right-0">
                    <a href="">Comenzi in asteptare</a>
                    <a href="" style="float: right;">Istoric comenzi</a>
                </h4>
                
                <br /><br /> -->
                <h2>Comenzile unui client</h2>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Client <span style="float: right; font-weight: bolder;"><a href="{{ route('users.edit', ['user'=>$order->user->id ]) }}">{{ $order->user->name }}</a></span></h5>
                                <hr>
